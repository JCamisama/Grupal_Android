...
public class GlobalVariablesUtil {
    ...
    public static final String INSERT_VOTED = "insert_voted.php";
    public static final String UPDATE_PUNTUATION = "update_puntuation.php";
    public static final String UPDATE_VOTED = "update_voted.php";
    public static final String GET_VOTED = "get_voted.php";
